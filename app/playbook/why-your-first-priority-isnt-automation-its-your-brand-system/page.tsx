      ...
      <main className="min-h-screen bg-brand-black">
        ...
        <section className="py-16 px-6 md:px-12">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              It makes you look consistent — which makes you look professional. Once your brand system is set up, you can start using <Link href="/playbook/stop-chasing-ai-tools" className="text-brand-gold hover:text-brand-gold-dark underline">the right AI tools</Link> to amplify your content.
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Creators who <em>don't skip it</em> build content in minutes. For a complete guide on building your <Link href="/playbook/content-engine-starter-kit" className="text-brand-gold hover:text-brand-gold-dark underline">AI-powered content engine</Link>, check out this resource.
            </p>
