...
export default function ContentEngineStarterKit() {
  const post = allInsights.find(p => p.slug === 'content-engine-starter-kit')
  ...
  return (
    <>
      <PostSchema
        ...
        slug={post?.slug || 'content-engine-starter-kit'}
        publishedDate={post?.publishedDate || '2025-11-11'}
        modifiedDate={post?.modifiedDate}
        coverImage={post?.coverImage}
        canonicalUrl={`https://lopezproductions.ai/playbook/${post?.slug || 'content-engine-starter-kit'}`}
        faqs={post?.faqs}
      />
      ...
      <main className="min-h-screen bg-brand-black">
        ...
        <section className="py-16 px-6 md:px-12">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Automation is where your content engine truly scales. It's also where most creators get stuck — because it's the most technical. For a beginner-friendly guide to building <Link href="/playbook/build-simple-business-automation-system" className="text-brand-gold hover:text-brand-gold-dark underline">simple automation systems</Link>, check out this resource.
            </p>
