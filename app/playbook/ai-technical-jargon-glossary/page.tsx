...
export default function AITechnicalJargonGlossary() {
  const post = allInsights.find(p => p.slug === 'ai-technical-jargon-glossary')
  ...
  return (
    <>
      <PostSchema
        ...
        slug={post?.slug || 'ai-technical-jargon-glossary'}
        publishedDate={post?.publishedDate || '2025-11-19'}
        modifiedDate={post?.modifiedDate}
        coverImage={post?.coverImage}
        canonicalUrl={`https://lopezproductions.ai/playbook/${post?.slug || 'ai-technical-jargon-glossary'}`}
        faqs={post?.faqs}
      />
      ...
      <main className="min-h-screen bg-brand-black">
        ...
        <section className="py-16 px-6 md:px-12">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              <em className="text-brand-gray-muted">Related reading: <Link href="/playbook/ai-prompting-essentials" className="text-brand-gold hover:text-brand-gold-dark underline">AI Prompting Essentials</Link></em>
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              <em className="text-brand-gray-muted">Related reading: <Link href="/playbook/build-simple-business-automation-system" className="text-brand-gold hover:text-brand-gold-dark underline">How To Build a Simple Automation</Link></em>
            </p>
            ...
            <ul className="list-disc pl-6 text-brand-gray-light space-y-2 mb-6">
              <li><Link href="/playbook/ai-prompting-essentials" className="text-brand-gold hover:text-brand-gold-dark underline">AI Prompting Essentials — The Skills Every Creator Needs</Link></li>
              ...
              <li><Link href="/playbook/ai-notion-weekly-organization" className="text-brand-gold hover:text-brand-gold-dark underline">How I Use AI to Organize My Week Inside Notion</Link></li>
              <li><Link href="/playbook/notion-creator-dashboard" className="text-brand-gold hover:text-brand-gold-dark underline">Notion for Creators — The Dashboard That Runs Your Entire Brand</Link></li>
            </ul>
