...
export default function NotionMakeAutomationGuide() {
  const post = allInsights.find(p => p.slug === 'notion-make-automation-guide')
  ...
  return (
    <>
      <PostSchema
        ...
        slug={post?.slug || 'notion-make-automation-guide'}
        publishedDate={post?.publishedDate || '2025-11-09'}
        modifiedDate={post?.modifiedDate}
        coverImage={post?.coverImage}
        canonicalUrl={`https://lopezproductions.ai/playbook/${post?.slug || 'notion-make-automation-guide'}`}
        faqs={post?.faqs}
      />
      ...
      <main className="min-h-screen bg-brand-black">
        ...
        <section className="py-16 px-6 md:px-12">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              First, create the database structure that will power your automation. Here's the exact setup. For creators, see <Link href="/playbook/notion-creator-dashboard" className="text-brand-gold hover:text-brand-gold-dark underline">this Notion dashboard guide</Link>.
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Now we'll build the automation workflows that connect everything together. For more automation strategies, see <Link href="/playbook/creator-automation-systems" className="text-brand-gold hover:text-brand-gold-dark underline">this creator automation guide</Link>.
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Once your basic workflows are running, add these advanced features. Before automating, make sure you have a solid <Link href="/playbook/why-your-first-priority-isnt-automation-its-your-brand-system" className="text-brand-gold hover:text-brand-gold-dark underline">brand system foundation</Link> in place.
            </p>
            ...
            <div className="mt-16 p-8 bg-brand-gray-dark rounded-2xl text-center">
              ...
              <p className="text-brand-gray-light mb-6">
                Get a free setup consultation and custom Notion + Make.com automation for your business. For more automation insights, explore <Link href="/playbook" className="text-brand-gold hover:text-brand-gold-dark underline">all our guides</Link>.
              </p>
