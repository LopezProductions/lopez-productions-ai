          ...
          {pillarPosts.length > 0 ? (
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {pillarPosts.map((insight) => {
                ...
                const href = isBlogPost ? `/playbook/${insight.slug}` : `/playbook/${insight.slug}`
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Start with the main pillar article: <Link href="/playbook/stop-chasing-ai-tools" className="text-brand-gold hover:text-brand-gold-dark underline">Stop Chasing Every New AI Tool — Here's What's Actually Worth Learning</Link>.
            </p>
          </div>
        </div>
      </section>
