        ...
        <section className="py-16 px-6 md:px-12">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Most creators spend more time on admin work than actual content creation. Planning, scheduling, cross-posting, and tracking analytics shouldn't consume 15+ hours of your week. For a complete guide to building <Link href="/playbook/build-simple-business-automation-system" className="text-brand-gold hover:text-brand-gold-dark underline">simple automation systems</Link>, start here.
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Before automating, make sure you have a solid <Link href="/playbook/why-your-first-priority-isnt-automation-its-your-brand-system" className="text-brand-gold hover:text-brand-gold-dark underline">brand system foundation</Link> in place.
            </p>
            ...
            <div className="rounded-2xl border border-brand-gray-dark bg-gradient-to-b from-white/5 to-transparent p-8 mb-8">
              ...
              <p className="text-brand-gray-light mb-4">
                <strong className="text-brand-white">Notion + AI-powered content planning:</strong> For a complete guide to setting up your <Link href="/playbook/notion-creator-dashboard" className="text-brand-gold hover:text-brand-gold-dark underline">Notion creator dashboard</Link>, see this resource.
              </p>
