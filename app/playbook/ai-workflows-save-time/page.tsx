      ...
      <main className="min-h-screen bg-brand-black">
        ...
        <section className="py-16 px-6 md:px-12">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              The difference between successful AI automation and failed implementations comes down to three factors. For creators looking to automate their workflows, see <Link href="/playbook/creator-automation-systems" className="text-brand-gold hover:text-brand-gold-dark underline">this guide</Link>.
            </p>
