      ...
      <main className="min-h-screen bg-brand-black">
        ...
        <section className="py-16 px-6 md:px-12">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              You <em>can</em> use AI ethically and effectively to make studying easier, faster, and more organized—<strong className="text-brand-white">without breaking academic rules.</strong>
            </p>
            ...
            <ul className="list-disc pl-6 text-brand-gray-light space-y-2 mb-6">
              ...
              <li>Ask: <strong className="text-brand-white">&quot;Give me a study guide / summary of this lecture.&quot;</strong></li>
            ...
            <p className="text-lg text-brand-gray-light mb-4 leading-relaxed">
              <strong className="text-brand-white">Perfect for:</strong>
            </p>
...
"Explain this section in simpler language."`}
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              One of the most underrated study hacks is setting up <strong className="text-brand-white">class folders</strong> in Notion (and even in ChatGPT) at the start of the semester.
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              When you use AI to <strong className="text-brand-white">understand</strong>, not to <strong className="text-brand-white">replace</strong>, your learning becomes deeper and faster.
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              They struggle because <strong className="text-brand-white">their system isn&apos;t working</strong>.
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              ...
              <Link href="/pricing" className="text-brand-gold hover:text-brand-gold-dark underline">
            ...
            <ul className="list-disc pl-6 text-brand-gray-light space-y-2 mb-6">
              <li>
                <Link href="/playbook/ai-notion-weekly-organization" className="text-brand-gold hover:text-brand-gold-dark underline">
                  How I Use AI to Organize My Week Inside Notion
                </Link>
              </li>
              <li>
                <Link href="/playbook/notion-creator-dashboard" className="text-brand-gold hover:text-brand-gold-dark underline">
