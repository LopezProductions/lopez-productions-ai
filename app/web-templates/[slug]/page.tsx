...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://lopezwebdesign.com/templates/${slug}`,
    },
    openGraph: {
...
export default async function TemplatePage({
  ...
  const imageUrl = `https://lopezwebdesign.com/templates/${slug}/cover.jpg`
  const templateUrl = `https://lopezwebdesign.com/templates/${slug}`
