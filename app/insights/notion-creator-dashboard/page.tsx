      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://lopezproductions.ai/insights/notion-creator-dashboard"
            }
          })
        }}
      />
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="mt-16 p-8 bg-brand-gray-dark rounded-2xl text-center border border-brand-gray-dark">
              ...
              <p className="text-lg text-brand-white font-semibold mb-6">
                <Link href="/get-started" className="text-brand-gold hover:text-brand-gold-dark transition-colors">
