...
export const metadata = {
  ...
  openGraph: {
    type: 'website',
    url: 'https://lopezproductions.ai/insights/creator-systems',
        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Once you have your brand system foundation in place, you can start building with <Link href="/insights/ai-workflows" className="text-brand-gold hover:text-brand-gold-dark underline">AI tools and workflows</Link> and then move on to <Link href="/insights/automation-systems" className="text-brand-gold hover:text-brand-gold-dark underline">business automation</Link>.
            </p>
            
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Start with the main pillar article: <Link href="/insights/notion-creator-dashboard" className="text-brand-gold hover:text-brand-gold-dark underline">Notion for Creators — The Simple Dashboard That Runs Your Entire Brand System</Link>.
            </p>
          </div>
        </div>
      </section>
