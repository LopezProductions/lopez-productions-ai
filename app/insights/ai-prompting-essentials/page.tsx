...
export const metadata = {
  ...
  openGraph: {
    type: 'article',
    url: 'https://lopezproductions.ai/insights/ai-prompting-essentials',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "AI Prompting Essentials — The Skills Every Creator Needs in 2025",
            "description": "A practical guide to the core prompting skills that help creators build faster, communicate clearly with AI, and run a smoother content engine.",
            "author": {
              "@type": "Person",
              "name": "Reuben Lopez",
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://lopezproductions.ai/insights/ai-prompting-essentials"
            }
          })
        }}
      />
        ...
        <section className="py-16 px-6 md:px-12">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-4 leading-relaxed">
              <em className="text-brand-gray-muted">Related: <Link href="/insights/stop-chasing-ai-tools" className="text-brand-gold hover:text-brand-gold-dark underline">Stop Chasing Every New AI Tool — Here's What's Actually Worth Learning</Link></em>
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-4 leading-relaxed">
              <em className="text-brand-gray-muted">Related: <Link href="/insights/ai-notion-weekly-organization" className="text-brand-gold hover:text-brand-gold-dark underline">How I Use AI to Organize My Week Inside Notion</Link></em>
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-4 leading-relaxed">
              <em className="text-brand-gray-muted">Related: <Link href="/insights/notion-creator-dashboard" className="text-brand-gold hover:text-brand-gold-dark underline">Notion for Creators — The Simple Dashboard That Runs Your Entire Brand System</Link></em>
            </p>
            ...
            <p className="text-lg text-brand-gray-light mb-4 leading-relaxed">
              <em className="text-brand-gray-muted">Related: <Link href="/insights/build-simple-business-automation-system" className="text-brand-gold hover:text-brand-gold-dark underline">How To Build a Simple Automation System for Your Business</Link></em>
            </p>
            ...
            <ul className="list-disc pl-6 text-brand-gray-light space-y-2 mb-6">
              ...
              <li><Link href="/insights/stop-chasing-ai-tools" className="text-brand-gold hover:text-brand-gold-dark underline">Stop Chasing Every New AI Tool — Here's What's Actually Worth Learning</Link></li>
            </ul>
