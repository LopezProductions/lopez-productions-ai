...
export const metadata = {
  ...
  openGraph: {
    type: 'website',
    url: 'https://lopezproductions.ai/insights/automation-systems',
        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg">
            ...
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Before automating, make sure you have a solid <Link href="/insights/creator-systems" className="text-brand-gold hover:text-brand-gold-dark underline">brand system foundation</Link> and the right <Link href="/insights/ai-workflows" className="text-brand-gold hover:text-brand-gold-dark underline">AI tools and workflows</Link> in place.
            </p>
            
            <p className="text-lg text-brand-gray-light mb-6 leading-relaxed">
              Start with the main pillar article: <Link href="/insights/build-simple-business-automation-system" className="text-brand-gold hover:text-brand-gold-dark underline">How To Build a Simple Automation System for Your Business (Beginner-Friendly Guide)</Link>.
            </p>
          </div>
        </div>
      </section>
